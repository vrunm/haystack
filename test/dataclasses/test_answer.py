...
extracted_answer_with = ExtractedAnswer(
    data="My name is Mark and I",
    ...
    probability=0.6086112260818481,
    start=0,
    end=21,
)
...
def test_to_dict_extracted_answer():
    extracted_answer = ExtractedAnswer(
        data="Giorgio and I",
        query="Who lives in Rome?",
        metadata={"text": "test metadata"},
...
def test_to_dict_extracted_answer_without_flattening():
    extracted_answer = ExtractedAnswer(
        data="Giorgio and I",
        query="Who lives in Rome?",
        metadata={"text": "test metadata"},
...
def test_from_dict_extracted_answer():
    data = {
        "data": "Giorgio and I",
        "query": "Who lives in Rome?",
        "document": {
...
def test_from_dict_extracted_answer_without_flattening():
    data = {
        "data": "Giorgio and I",
        "query": "Who lives in Rome?",
        "metadata": {"text": "test metadata"},
...
def test_from_dict_extracted_answer_with_flat_and_non_flat_meta():
...
def test_to_dict_generated_answer():
    generated_answer = GeneratedAnswer(
        data="Mark and I",
        query="Who lives in Berlin?",
        metadata={"text": "test metadata"},
...
def test_to_dict_generated_answer_without_flattening():
    generated_answer = GeneratedAnswer(
        data="Mark and I",
        query="Who lives in Berlin?",
        metadata={"text": "test metadata"},
...
def test_from_dict_generated_answer():
    data = {
        "data": "Mark and I",
        "query": "Who lives in Berlin?",
        "documents": [
...
def test_from_dict_generated_answer_without_flattening():
    data = {
        "data": "Mark and I",
        "query": "Who lives in Berlin?",
        "metadata": {"text": "test metadata"},
...
def test_from_dict_generated_answer_with_flat_and_non_flat_meta():
    with pytest.raises(ValueError, match="Pass either the 'metadata' parameter or flattened metadata keys"):
